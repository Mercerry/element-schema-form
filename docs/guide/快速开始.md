...
```bash
npm i @mercerry/element-schema-form -S
```

or

```bash
yarn add @mercerry/element-schema-form
```
...
```js
import SchemaFormCodemirror from '@mercerry/element-schema-form/lib/SchemaFormCodemirror.common.min'
